...
$(document).ready(function(){
    ...
    jQuery('#headerwrap.agency-slider').backstretch([
        "resources/assets/img/agency/hero1.jpg",
        "resources/assets/img/agency/hero2.jpg",
        "resources/assets/img/agency/hero3.jpg"
    ...
    $(document).on( 'shown.bs.tab', 'a[href="#contact2"]', function (e) {
        $("#mapwrapper").gMap({ 
            ...
            markers: [{     
                latitude:40.7566,
                longitude: -73.9863,
            icon: { image: "resources/assets/img/marker.png",
                iconsize: [44,44],
                iconanchor: [12,46],
