							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											<img height="300" src="/prj/fileUp${list.bookCoverPath}${list.bookCover}" alt="" />
											<h2>$56</h2>
											<p>${list.bookNm}</p>
										</div>
								</div>
								...
								<div class="choose">
									<ul class="nav nav-pills nav-justified">
										<li><a href="#"><i class="fa fa-plus-square"></i>Add to Bucket</a></li>
										<li><a href="#"><i class="fa fa-shopping-cart"></i>Add to Cart</a></li>
									</ul>
								</div>
							</div>
							<c:if test="${list.bookDiscnt != '0'}">
								<img src="resources/images/home/sale.png" class="new" alt="" />
							</c:if>
							<c:if test="${list.bookDiscnt eq '0'}">
