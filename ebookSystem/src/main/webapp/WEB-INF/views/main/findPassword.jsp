		...
		<div>
	        <form method="post" action="find_password" name="findform" id = "frm">
	            ...
	            <div class="box_login">
	                ...
	                <input id="memberId" name="memberId" type="text" placeholder="Id">
	                </div>
	                <div class="inp_text">
	                <label for="memberNm" class="screen_out">Name</label>
	                <input type="text" id="memberNm" name="memberNm" placeholder="Name">
	                </div>
	                <div class="inp_text">
	            ...
	            <div>
	            <button type="button" class="btn_login" id="ckPass">Check</button>
	            </div><br>
	            </c:if>
				 ...
				 <div class="inner_login">
					...
					<div></div>
	           			...
	           			<div class="box_login">
			                ...
			                <label for="password" class="screen_out">Password</label>
			                <input id="password" name="pwd" type="password" placeholder="Password">
			                </div>
			                
			                <div class="inp_text">
			                <label for="confirmpassword" class="screen_out">Confirm Password</label>
			                <input type="password" id="confirmpassword" name="confirmpwd" placeholder="confirm password">
			                </div>
	           		 	</div><br>
	           			 <div>
