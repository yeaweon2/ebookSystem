...
<body>
	<div class="inner-page pt-6">
		<div class="container">
			...
			<table class="table">
				<tr>
					<th colspan="6">${inquire.cmmntyTitle}</th>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="6" height="300">${inquire.cmmntyContents}</td>
				</tr>
			</table>
	...
	//원글 수정,삭제
      function inquireEdit(str) {
         if (str == 'U') {
            frm.action = "inquireUpdateForm";
     	 } else {
              if (confirm('삭제하시겠습니까?') == true) {
               frm.action = "inquireDelete";
              } else {
               return false;
            } //else
         }//else
